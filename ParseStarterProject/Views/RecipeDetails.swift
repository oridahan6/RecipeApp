...
class RecipeDetails: UIView {
    ...
    private func drawTitle() {
        ...
        title.drawInRect(CGRectMake(100, 5, self.frame.size.width - 5 - 100.0, 25.0), withAttributes: attributes)
        self.titleSize = title.sizeWithAttributes(attributes)
    }
    
    private func drawUpdatedAt() {
